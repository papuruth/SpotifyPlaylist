            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-12">
                        {!this.state.token && <a href='https://spotifyplaylist-trackinfo.herokuapp.com/login' className="form-control btn btn-primary" > Login to Spotify </a>}
                    </div>
                </div>
                <div className="row" style={{ background: '#000' }}>
                    ...
                    <div className="col-sm-8">
                        <h1 style={{color: '#fff'}}>{this.state.message}</h1>
