            ...
            <div className="container">
                <div className="header-wrapper">
                    ...
                    <div className="search-wrapper">
                        <div className="form-group mb-2 mx-sm-3 form-wrapper">
                            <label className="search-label">
                                <input id="searchInput" className="search-input" type="text" maxLength="80" autoCorrect="off" autoCapitalize="off" name="searchInput" onChange={this.handleChange} value={searchInput} placeholder="Search for track, playlist, album and artist..." />
                            </label>
                            <div className="search-icon-wrapper">
                                <span className="search-icon-style">
                                    <svg onClick={this.searchSpotify} height="24" role="img" width="24" viewBox="0 0 512 512" className="svg-icon-style" aria-hidden="true">
                                ...
                                <button className="clear-search-wrapper" aria-label="Clear search field">
                                    <svg onClick={this.clearSearch} height="24" role="img" width="24" viewBox="0 0 24 24" className="svg-icon-style">
